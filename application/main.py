...
def get_entry_rectangle():
    try:
        ...
        answer.configure(text=f'Площадь квадрата при введенных \n'
                              f'значениях {value1} и {value2} \n'
                              f'равна: {value1 * value2}', fg='black')
        pole1.delete(0, END)
        pole2.delete(0, END)
    except ValueError:
...
def get_entry_circle():
    try:
        ...
        answer.configure(text=f'Площадь круга при введенном \n'
                              f'радиусе {value3}\n'
                              f'равна: {3.14 * value3 * value3}', fg='black')
        pole3.delete(0, END)
    except ValueError:
        answer.configure(text='Введите корректные данные!', fg='red')
        pole3.delete(0, END)
...
label = tk.Label(win, text='Вычислить площадь прямоугольника', font=('Arial', 10, 'bold'))
...
n = tk.Label(win, text='Введите данные')
n.place(relx=0.28, rely=0.07, anchor='e')
n1 = tk.Label(win, text='Введите данные')
...
label1 = tk.Label(win, text='Вычислить площадь круга', font=('Arial', 10, 'bold'))
...
answer = tk.Label(win, text='Вывод результата вычисления...', font=('Arial', 12, 'bold'))
